...
export default function MerenrantaScreen() {
    ...
    React.useCallback(() => {
      ...
      async function loadSound() {
        const { sound } = await Audio.Sound.createAsync(
          require('../../../assets/sounds/jazz-charm-loop-312715.mp3'),
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={StyleSheet.absoluteFill}>
        <Video
          source={require('../../../assets/videos/MakuuhuoneTurvapaikka.mp4')}
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.content}>
          <Text style={[styles.title, { color: textColor }]}>Makuuhuone</Text>
          <Text style={[styles.description, { color: textColor }]}>
            Rentoudu tutussa ja turvallisessa ympäristössä.
          </Text>
        </View>
      </View>
