...
export default function NuotioScreen() {
    ...
    React.useCallback(() => {
      ...
      async function loadSound() {
        const { sound } = await Audio.Sound.createAsync(
          require('../../../assets/sounds/fireplace-6160.mp3'),
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={StyleSheet.absoluteFill}>
        <Video
          source={require('../../../assets/videos/6507522-hd_1080_1920_25fps.mp4')}
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.content}>
          <Text style={[styles.title, { color: textColor }]}>Nuotio</Text>
          <Text style={[styles.description, { color: textColor }]}>
            Nauti nuotion lämmöstä ja rauhasta.
          </Text>
        </View>
      </View>
