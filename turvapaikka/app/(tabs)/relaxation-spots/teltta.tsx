...
export default function TelttaScreen() {
  ...
  // Takaisin-nuolen toiminto: pysäytetään ääni ja navigoidaan takaisin
  ...
  return (
    <View style={[styles.container, { backgroundColor }]}>
      ...
      <View style={StyleSheet.absoluteFill}>
        <Video
          source={require('../../../assets/videos/13087682_1440_2562_30fps.mp4')}
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.content}>
          <Text style={[styles.title, { color: textColor }]}>Teltta</Text>
          <Text style={[styles.description, { color: textColor }]}>
            Tunne olosi turvalliseksi teltassa.
          </Text>
        </View>
      </View>
